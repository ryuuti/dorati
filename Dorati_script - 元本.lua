...
local function Koumoku()
    local function AddStatusA(args)
        local value = {type = "A",isEnabled = args["isEnabled"] or off, Num = args["Num"], Name = args["Name"] , toggle = args["toggle"]}
        Status[args["Name"]] = value
        Status["A"][args["Num"]] = value
        group[args["Tag"]] = group[args["Tag"]] or {}
        table.insert(group[args["Tag"]], args["Name"])
        return args["Num"] +1
    end
    local function AddStatusB(args)
        local value = {type = "B",isEnabled = args["isEnabled"] or off, Num = args["Num"], Name = args["Name"], N = args["N"], LD = args["LD"] or nil}
        Status[args["Name"]] = value
        Status["B"][args["Num"]] = value
        group[args["Tag"]] = group[args["Tag"]] or {}
        table.insert(group[args["Tag"]], args["Name"])
        return args["Num"] +1
    end
    ...
    Addchoicetbl(nil,"⚠️注意事項⚠️","tyuui")
    Addchoicetbl(nil,"一括設定",{["type"]= "multiChoice",["value"] = {},["order"] = {}})
    Addchoicetbl(nil,"個別設定",{["type"]= "multiChoice",["value"] = {},["order"] = {}})
    Addchoicetbl(nil,"スクリプト履歴削除","fileremove")
    Addchoicetbl(nil,"ログアウト","logaut")
    Addchoicetbl(nil,"スクリプト終了","Scriptend")
    Addchoicetbl(choicetbl["value"]["一括設定"],"NoneA","ButtonA")
    Addchoicetbl(choicetbl["value"]["一括設定"],"戻る","back")
    Addchoicetbl(choicetbl["value"]["個別設定"],"ドロップ系",{["type"]= "multiChoice",["value"] = {},["order"] = {}})
    Addchoicetbl(choicetbl["value"]["個別設定"],"無効系",{["type"]= "multiChoice",["value"] = {},["order"] = {}})
    --Addchoicetbl(choicetbl["value"]["個別設定"],"ゲート系",{["type"]= "multiChoice",["value"] = {},["order"] = {}})
    Addchoicetbl(choicetbl["value"]["個別設定"],"NoneB","ButtonB")
    Addchoicetbl(choicetbl["value"]["個別設定"],"戻る","back")
    Addchoicetbl(choicetbl["value"]["個別設定"]["value"]["ドロップ系"],"drop","ButtonB")
    Addchoicetbl(choicetbl["value"]["個別設定"]["value"]["ドロップ系"],"閉じる","end")
    Addchoicetbl(choicetbl["value"]["個別設定"]["value"]["無効系"],"Mukou","ButtonB")
    Addchoicetbl(choicetbl["value"]["個別設定"]["value"]["無効系"],"閉じる","end")
    --Addchoicetbl(choicetbl["value"]["個別設定"]["value"]["ゲート系"],"gate","ButtonB")
    --Addchoicetbl(choicetbl["value"]["個別設定"]["value"]["ゲート系"],"閉じる","end")
    if true then
        local i = 1
        Status["A"] = {}
        i = AddStatusA({["Tag"] = "NoneA",["Num"] = i, ["Name"] = "おすすめ倍速遅延(UG)", ["toggle"] = {["倍速"] = {[on] = S_(2), [off] = off}, ["ぷに遅延"] = {[on] = S_(3), [off] = off}}})
        i = AddStatusA({["Tag"] = "NoneA",["Num"] = i, ["Name"] = "おすすめ倍速遅延(PC)", ["toggle"] = {["倍速"] = {[on] = S_(3), [off] = off}, ["ぷに遅延"] = {[on] = S_(1), [off] = off}}})
        i = AddStatusA({["Tag"] = "NoneA",["Num"] = i, ["Name"] = "完凸用", ["toggle"] = {["ワンパン"] = {[on] = on, [off] = off}, ["敵ターン無効"] = {[on] = on, [off] = off}, ["スコア"] = {[on] = on, [off] = off}, ["アイテム泥無効"] = {[on] = on, [off] = off}, ["妖怪泥無効"] = {[on] = off, [off] = on}, ["鍵演出スキップ"] = {[on] = on, [off] = off}, ["リザルトスキップ"] = {[on] = on, [off] = off}, ["フレンドアイコン無効"] = {[on] = on, [off] = off}, ["会話無効"] = {[on] = on, [off] = off}, ["虫眼鏡無効"] = {[on] = on, [off] = off}, ["封印無効"] = {[on] = on, [off] = off},["確泥(妖怪)"] = {[on] = on, [off] = off}, ["確泥エラー回避"] = {[on] = on, [off] = off}}})
        i = AddStatusA({["Tag"] = "NoneA",["Num"] = i, ["Name"] = "Yポ周回用", ["toggle"] = {["ワンパン"] = {[on] = on, [off] = off}, ["敵ターン無効"] = {[on] = on, [off] = off}, ["スコア"] = {[on] = on, [off] = off}, ["妖怪泥無効"] = {[on] = on, [off] = off}, ["鍵演出スキップ"] = {[on] = on, [off] = off}, ["リザルトスキップ"] = {[on] = on, [off] = off}, ["フレンドアイコン無効"] = {[on] = on, [off] = off}, ["会話無効"] = {[on] = on, [off] = off}, ["虫眼鏡無効"] = {[on] = on, [off] = off}, ["封印無効"] = {[on] = on, [off] = off}, }})
        i = AddStatusA({["Tag"] = "NoneA",["Num"] = i, ["Name"] = "アイテム周回用", ["toggle"] = {["ワンパン"] = {[on] = on, [off] = off}, ["敵ターン無効"] = {[on] = on, [off] = off}, ["スコア"] = {[on] = on, [off] = off}, ["アイテム泥無効"] = {[on] = off, [off] = on}, ["妖怪泥無効"] = {[on] = on, [off] = off}, ["鍵演出スキップ"] = {[on] = on, [off] = off}, ["リザルトスキップ"] = {[on] = on, [off] = off}, ["フレンドアイコン無効"] = {[on] = on, [off] = off}, ["会話無効"] = {[on] = on, [off] = off}, ["虫眼鏡無効"] = {[on] = on, [off] = off}, ["封印無効"] = {[on] = on, [off] = off},}})
        i = AddStatusA({["Tag"] = "NoneA",["Num"] = i, ["Name"] = "初期垢用スキップ", ["toggle"] = {["チュートリアルスキップ"] = {[on] = on, [off] = off},["スコアタ郵便イベ解放"] = {[on] = on, [off] = off}}})
    end
    if true then
        local i = 1
        Status["B"] = {}
        i = AddStatusB({["Tag"] = "drop",["Num"] = i, ["Name"] = "確泥(妖怪)",
                        ["LD"] = {[1] = {["offset"] = 0x3001608, ["E"] = {[off] = "h F0 B5 03 AF",[on] = "h 70 47 00 00"}}},
                        ["N"] = {[1] = {["offset"] = 0x3903300, ["E"] = {[off] = "h F6 03 1F 2A",[on] = "h 20 11 22 2A"}}}})
        i = AddStatusB({["Tag"] = "drop",["Num"] = i, ["Name"] = "確泥エラー回避",
                        ["N"] = {[1] = {["offset"] = 0x3EF9B9C, ["E"] = {[off] = "h E0 03 1F 2A",[on] = "h 20 00 80 52"}}}})
        i = AddStatusB({["Tag"] = "drop",["Num"] = i, ["Name"] = "妖怪泥無効",
                        ["LD"] = {[1] = {["offset"] = 0x3001608, ["E"] = {[off] = "h F0 B5 03 AF",[on] = "h 00 20 70 47"}}},
                        ["N"] = {[1] = {["offset"] = 0x39032C4, ["E"] = {[off] = "h F3 03 1F 2A",[on] = "h 33 00 80 52"}}}})
        i = AddStatusB({["Tag"] = "drop",["Num"] = i, ["Name"] = "アイテム泥無効",
                        ["LD"] = {[1] = {["offset"] = 0x300159C, ["E"] = {[off] = "h F0 B5 03 AF",[on] = "h 00 20 70 47"}}},
                        ["N"] = {[1] = {["offset"] = 0x31F5248, ["E"] = {[off] = "h FD 7B BA A9",[on] = "h C0 03 5F D6"}}}})
        i = AddStatusB({["Tag"] = "Mukou",["Num"] = i, ["Name"] = "フレンドアイコン無効",
        ...
        i = AddStatusB({["Tag"] = "Mukou",["Num"] = i, ["Name"] = "会話無効",
        ...
        i = AddStatusB({["Tag"] = "Mukou",["Num"] = i, ["Name"] = "虫眼鏡無効",
...
local function ShokiSettei()
    if os.date("%Y%m%d%H%M") >= "202411152359" then
