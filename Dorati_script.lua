...
local function Koumoku()
    ...
    if true then
        ...
        i = AddStatus({["type"] = "B", ["Tag"] = "drop",["Num"] = i, ["Name"] = "確泥(妖怪)",
                        ...
                        ["N"] = {[1] = {["offset"] = "3918774", ["E"] = {[off] = "h F6 03 1F 2A",[on] = "h 20 11 22 2A"}}}})
        ...
        i = AddStatus({["type"] = "B", ["Tag"] = "Mukou",["Num"] = i, ["Name"] = "虫眼鏡無効",
                        ...
                        ["N"] = {[1] = {["offset"] = "44F97E8", ["E"] = {[off] = "h FF 43 02 D1",[on] = "h C0 03 5F D6"}},
                                 [2] = {["offset"] = "46CFE48", ["E"] = {[off] = "h FF 43 02 D1",[on] = "h C0 03 5F D6"}}}})
        ...
        i = AddStatus({["type"] = "B", ["Tag"] = "Mukou",["Num"] = i, ["Name"] = "ランキング無効",
                        ["N"] = {[1] = {["offset"] = "449D2F8", ["E"] = {[off] = "h FD 7B BA A9",[on] = "h C0 03 5F D6"}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "Mukou",["Num"] = i, ["Name"] = "スコアタ無効",
                        ["N"] = {[1] = {["offset"] = "430FD9C", ["E"] = {[off] = "h FF C3 05 D1",[on] = "h C0 03 5F D6"}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "Mukou",["Num"] = i, ["Name"] = "郵便無効",
                        ["N"] = {[1] = {["offset"] = "42A2BF4", ["E"] = {[off] = "h FF C3 02 D1",[on] = "h C0 03 5F D6"}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "Mukou",["Num"] = i, ["Name"] = "封印無効",
                        ["LD"] = {[1] = {["offset"] = "371E588", ["E"] = {[off] = "h B0 B5 02 AF",[on] = "h 70 47 02 AF"}}},
                        ["N"] = {[1] = {["offset"] = "46D068C", ["E"] = {[off] = "h FF C3 02 D1",[on] = "h C0 03 5F D6"}}}})
        ...
        i = AddStatus({["type"] = "B", ["Tag"] = "NoneB",["Num"] = i, ["Name"] = "倍速",
                        ...
                        ["N"] = {[1] = {["offset"] = "2360CB4", ["E"] = {[off] = "h 4D 62 50 3F",[S_(1)] = "h 9A 99 59 3F",[S_(2)] = "h 52 B8 5E 3F",[S_(3)] = "h 66 66 66 3F"}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "NoneB",["Num"] = i, ["Name"] = "ぷに遅延",
                        ["N"] = {[1] = {["offset"] = "3956104", ["E"] = {[off] = "h 00 18 28 1E",[S_(1)] = "h 00 50 2A 1E ",[S_(2)] = "h 00 D0 28 1E ",[S_(3)] = "h 00 10 28 1E "}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "NoneB",["Num"] = i, ["Name"] = "ワンパン",
                        ["LD"] = {[1] = {["offset"] = "312DAF8", ["E"] = {[off] = "h C2 68 01 2A",[on] = "h C2 68 00 2A"}}},
                        ["N"] = {[1] = {["offset"] = "3B3B7D8", ["E"] = {[off] = "h 81 00 00 54",[on] = "h 80 00 00 54"}}}})
        ...
        i = AddStatus({["type"] = "B", ["Tag"] = "NoneB",["Num"] = i, ["Name"] = "鍵演出スキップ",
                        ...
                        ["N"] = {[1] = {["offset"] = "49035FC", ["E"] = {[off] = "h 01 09 40 B9 21 03 00 34",[on] = "h 1F 09 40 B9 21 03 00 35"}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "NoneB",["Num"] = i, ["Name"] = "チュートリアルスキップ",
                        ["LD"] = {[1] = {["offset"] = "3D5FB78", ["E"] = {[off] = "h 01 01 01 01",[on] = "h 00 00 00 00"}}},
                        ["N"] = {[1] = {["offset"] = "51001CC", ["E"] = {[off] = "h 01 01 01 01",[on] = "h 00 00 00 00"}}}})
        i = AddStatus({["type"] = "B", ["Tag"] = "NoneB",["Num"] = i, ["Name"] = "スコアタ郵便イベ解放",
                        ["LD"] = {[1] = {["offset"] = "3605554", ["E"] = {[off] = "h F8 B5 04 AF",[on] = "h 70 47 04 AF"}}},
                        ["N"] = {[1] = {["offset"] = "449C8EC", ["E"] = {[off] = "h FF 03 01 D1",[on] = "h C0 03 5F D6"}},
                                 [2] = {["offset"] = "4672F84", ["E"] = {[off] = "h 21 00 80 52",[on] = "h E1 03 1F 2A"}}}})
    end
end
